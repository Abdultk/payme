        ...
        <div class="row">
          <div class="col-lg-6 wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.3s">
            <div class="video-thumb">
              <img src="{{ get_image('assets/images/frontend/about/'.$aboutCaption->data_values->image) }}" alt="image" class="w-100">
              <a class="ytp-title-link yt-uix-sessionlink" target="_blank" data-sessionlink="feature=player-title" tabindex="-1" href="https://www.youtube.com/watch?v=yMw2OD60pOY"></a>
            </div>
          </div>
